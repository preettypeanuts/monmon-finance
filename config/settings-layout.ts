...
export const SETTINGS_SCROLL = [
  ...
  "pb-[calc(1rem+var(--mobile-safe-bottom))] pt-4",
].join(" ");
...
export const SETTINGS_HEADER = [
  "flex shrink-0 items-center justify-between border-b border-black/6",
  MOBILE_SAFE_HORIZONTAL_INSET,
  "pb-3 pt-[var(--mobile-safe-top)]",
  "dark:border-white/8",
].join(" ");

export const SETTINGS_SHEET = `${SEPARATED_SURFACE} ${GLASS_SURFACE} w-full gap-0 border-0 p-0 shadow-2xl sm:max-w-[22rem]`;
