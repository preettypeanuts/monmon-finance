...
export const FORM_DIALOG_CONTENT = `flex max-h-[min(calc(100dvh-2rem),56rem)] flex-col gap-0 p-0 ${FORM_DIALOG_SURFACE} sm:max-w-md`;
...
export const FORM_DIALOG_FOOTER =
  "flex shrink-0 gap-2 border-t border-black/8 bg-black/2 px-6 py-4 dark:border-white/10 dark:bg-white/3";
